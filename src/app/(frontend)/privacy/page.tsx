    ...
    <SiteFrame>
      <RichTextSection>
        ...
        >
          ...
          <p>
            אתר זה משמש כעמוד מידע ויצירת קשר בלבד. אנו מכבדים את פרטיות המשתמשים באתר
            ומתחייבים לעשות שימוש במידע הנמסר אך ורק לצורך טיפול בפניות.
          </p>
          ...
          <div>
            ...
            <p>
              המידע הנשלח דרך טופס יצירת הקשר משמש אך ורק לצורך יצירת קשר עם הפונה ומתן
              מענה לפנייה.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ההודעות הנשלחות דרך האתר מועברות למערכת פנימית של מנהלי האתר (קבוצת Telegram
              פרטית) לצורך טיפול בפנייה.
            </p>
          </div>
