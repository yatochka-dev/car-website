    ...
    <SiteFrame>
      <RichTextSection>
        ...
        >
          ...
          <p>
            השימוש באתר כפוף לתנאים המפורטים להלן. גלישה באתר או שימוש בו מהווים הסכמה
            לתנאים אלו.
          </p>
          ...
          <div>
            ...
            <p>
              האתר נועד להציג מידע אודות השירותים המוצעים ולאפשר יצירת קשר עם בעלי האתר.
              אין לעשות שימוש באתר למטרות בלתי חוקיות או לשלוח דרך טופס יצירת הקשר תוכן
              פוגעני, מטעה או זדוני.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              המידע באתר מוצג כפי שהוא ("AS IS"). בעלי האתר אינם מתחייבים כי המידע באתר
              יהיה מלא, מדויק או מעודכן בכל עת.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              כל התכנים באתר, לרבות טקסטים, עיצוב, תמונות וסימנים מסחריים, שייכים לבעלי
              האתר ואין לעשות בהם שימוש ללא אישור.
            </p>
          </div>
